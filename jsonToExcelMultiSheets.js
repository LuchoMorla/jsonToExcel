...
const convertJsonToExcel = (docName) => {

const sheet1 = name.orders;
const sheet2 = name.customers;
const sheet3 = name.items;
const sheet4 = name.orderProducts;

const json1 = metods.orders;
const json2 = metods.customers;
const json3 = metods.items;
const json4 = metods.orderProducts;

const workSheet1 = XLSX.utils.json_to_sheet(json1);
const workSheet2 = XLSX.utils.json_to_sheet(json2);
const workSheet3 = XLSX.utils.json_to_sheet(json3);
const workSheet4 = XLSX.utils.json_to_sheet(json4);

const workBook = XLSX.utils.book_new();

XLSX.utils.book_append_sheet(workBook, workSheet1, `${sheet1}`, true);
XLSX.utils.book_append_sheet(workBook, workSheet2, `${sheet2}`, true);
XLSX.utils.book_append_sheet(workBook, workSheet3, `${sheet3}`, true);
XLSX.utils.book_append_sheet(workBook, workSheet4, `${sheet4}`, true)
// Generate buffer
...
const documentName = 'ordenUser2';
convertJsonToExcel(documentName);